...
public interface HouseholdService {
    HouseholdCommands.HouseholdCreatedResult createHouseHold(Create createCommand);

    Optional<HouseholdCommands.HouseholdCreatedResult> addMembers(HouseholdCommands.AddMembers addMembersCommand);
